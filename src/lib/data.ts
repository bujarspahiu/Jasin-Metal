...
export const TRANSLATIONS = {
  en: {
    ...
    admin: {
      ...
      products: { title: 'Products', addProduct: 'Add Product', searchProducts: 'Search products...', allCategories: 'All Categories', product: 'Product', sku: 'SKU', category: 'Category', price: 'Price', stock: 'Stock', status: 'Status', active: 'Active', noProductsFound: 'No products found for', clearFilters: 'CLEAR FILTERS', productsWord: 'products' },
  ...
  sq: {
    ...
    admin: {
      ...
      products: { title: 'Produktet', addProduct: 'Shto Produkt', searchProducts: 'Kërko produkte...', allCategories: 'Të gjitha Kategoritë', product: 'Produkti', sku: 'Kodi', category: 'Kategoria', price: 'Çmimi', stock: 'Stoku', status: 'Statusi', active: 'Aktiv', noProductsFound: 'Nuk u gjet asnjë produkt për', clearFilters: 'FSHI FILTRAT', productsWord: 'produkte' },
